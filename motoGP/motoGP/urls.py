...
urlpatterns = patterns('',
    ...
    url(r'^pilot/(?P<pk>\d+)/modify/$',login_required(UpdatePilot.as_view()), name="pilot_modify"),
    url(r'^pilot/(?P<pk>\d+)/delete/$',login_required(DeleteView.as_view(model=Pilot, success_url="/pilot/",template_name="management/deletePilot.html")), name="pilot_delete"),
    ...
    url(r'^create/new_pilot/$',login_required(CreatePilot.as_view()), name='pilot_create'),
