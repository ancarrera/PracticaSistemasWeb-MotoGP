...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PilotReview'
        db.create_table(u'appMotoGP_pilotreview', (
            ...
            ('pilot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['appMotoGP.Pilot'])),
        ))
        db.send_create_signal(u'appMotoGP', ['PilotReview'])


    def backwards(self, orm):
        # Deleting model 'PilotReview'
        db.delete_table(u'appMotoGP_pilotreview')
